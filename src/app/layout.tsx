...
export const metadata: Metadata = {
  title: "TechInnovate - Transforming IT Solutions",
  description: "Discover innovative technology solutions with TechInnovate, empowering businesses to thrive.",
  openGraph: {
    title: "TechInnovate - Transforming IT Solutions",
    description: "Discover innovative technology solutions with TechInnovate, empowering businesses to thrive.",
    images: [{ url: "https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Innovative IT Solutions" }],
    siteName: "TechInnovate",
    type: "website"
  }
};
